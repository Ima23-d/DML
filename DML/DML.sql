INSERT INTO Alunos (Nome_Aluno, CPF, Data_Nascimento, Idade, Peso, Gordura_Corporal, Nivel, Deficiencia, Email)
VALUES ('Maria Silva', '123.456.789-00', '2000-05-10', 24, 60.5, 18.3, 'Intermediário', NULL, 'maria@gmail.com');
